    ...
    <body>
         <div class="container-fluid p-0 d-flex">
                 ...
                 <div class="container-fluid p-0 admin-header" style="margin-left:17.8rem">
                     <div class="bg-white">
                         <h3 class="p-3">View Store Address</h3>
                     </div>
                     <div class="show-products">
                      ...
                      <tr>
                          ...
                          <td>
                               <a href="edit-store.jsp?id=<%= rs.getInt(1) %>"><i class="fas fa-edit pe-3 fs-5"></i></a>
                              <a href="deletestore?id=<%= rs.getInt(1) %>"><i class="fa fa-trash pe-3 fs-5"></i></a></td>
                      </tr>
                      <%
                          }
                          }
